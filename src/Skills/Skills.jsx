...
import { AndroidOriginal, BootstrapOriginal, CplusplusOriginal, DartOriginal, DjangoPlain, FirebasePlain, FlutterOriginal, GitOriginal, Html5Original, JavaOriginal, JavascriptOriginal, KotlinPlain, LinuxOriginal, PythonOriginal, ReactOriginal, SequelizeOriginal, SpringOriginal, TypescriptOriginal, VscodeOriginal, VuejsOriginal } from 'devicons-react';
                    ...
                    <Stack direction={mobile ? 'column' : "row"} spacing={mobile ? 2 : 5}>
                        ...
                        <Stack direction={mobile ? 'row' : "column"} spacing={1} justifyContent={'center'}>
                            <Stack direction={mobile ? 'column' : "row"} spacing={3} sx={{ marginBottom: '10px' }}>
                                ...
                                <Chip className={classes.chipFont} icon={<FaFileExcel />} label="Excel" variant="outlined" />
                            </Stack>
                            <Stack direction={mobile ? 'column' : "row"} spacing={3}>
                                <Chip className={classes.chipFont} icon={<VscodeOriginal />} label="VSCode" variant="outlined" />
                                <Chip className={classes.chipFont} icon={<GitOriginal />} label="Git" variant="outlined" />
